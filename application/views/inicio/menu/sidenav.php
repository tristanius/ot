    ...
    <li ng-if="validGestion('contrato')"> <!-- Revisar -->
      ...
      <div class="collapsible-body">
        <ul class="blue lighten-5">
          <li> <a href="#" class="sidenav-close font12" ng-click="clickeableLink('<?= site_url('contrato/gestion') ?>', $event, 'Maestro de contrato'); closeMenu()">1.2. Maestro de contratos</a> </li>
      ...
      <div class="collapsible-body">
        <ul class="blue lighten-5">
          ...
          <li ng-if="validPriv(68)">
            <a href="#" class="sidenav-close font12" ng-click="clickeableLink('<?= site_url('consulta/form_estado_reportes') ?>', $event, 'Estados de reportes'); closeMenu()">4.2. Estados de reportes</a>
          </li>
          <li ng-if="validPriv(68)">
            <a href="#" class="sidenav-close font12" ng-click="clickeableLink('<?= site_url('consulta/form_indicadores_ot') ?>', $event, 'Cant. item mes a mes'); closeMenu()">4.3. Cantidades reportadas por mes</a>
          </li>
        </ul>
      </div>
    </li>
