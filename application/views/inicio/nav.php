    ...
    <ul id="nav-mobile" class="left hide-on-med-and-down">
      <li data-target="slide-out" class="sidenav-trigger">
        <a href="#" class="valign-wrapper">
          <img src="<?= base_url("assets/img/icons/icon-menu.png") ?>" style="max-width:5ex">
          <b>Menú</b>
        </a>
      </li>
      <li style="color:#222;"> <span class="valign-wrapper" style="min-height:35px">Version: 1.89.11</span> </li>
    </ul>
    <ul class="center">
