<section id="formFactura" class="windowCentered2 row" ng-controller="formFactura" >
  ...
  <div class="btnWindow" ng-show="!spinner">
    ...
    <button type="button" class="waves-effect waves-light btn red mini-btn2" ng-click="removeTinyMCE('#notas'); confirmarCerrar('¿Estas seguro de cerrar el formulario de factura?','#ventanaFactura', enlaceGetFactura)" data-icon="n"> Cerrar</button>
  </div>
</section>
