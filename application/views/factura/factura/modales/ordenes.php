<div id="ordenes" class="modal">
  ...
  <div class="modal-footer">
    <a href="#!" class="btn mini-btn modal-close" ng-click="selectedOTs(); getRecursos('<?= site_url('factura/get_recursos')  ?>')" ng-if="!factura.validado && !factura.idfactura"> filtrar las O.T. seleccionadas. </a>
