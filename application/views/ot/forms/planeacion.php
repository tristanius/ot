		...
		<table class="mytabla largWidth">
			...
			<tbody class="font11">
				...
				<tr ng-repeat="act in tr.actividades | orderBy: 'codigo'">
					...
					<td style="text-align: right"> <small ng-bind="act.subtarifa | currency:'$':0"></small> <input type="text" ng-model="act.subtarifa" style="max-width:10ex;" v ng-init="act.subtarifa = act.subtarifa?act.subtarifa:act.tarifa"> </td>
				...
				<tr>
					<th colspan="12" rowspan="" style="background:#ddedd0">PERSONAL</th>
				</tr>
				<tr ng-repeat="per in tr.personal | orderBy: 'codigo'">
					<td> <span data-icon="&#xe039;" style="color:#6ce25d" ng-click="dialog('Codigo interno: '+per.codigo)"></span> <span ng-bind="per.itemc_item"></span> </td>
					...
					<td style="text-align: right" > <small ng-bind="per.subtarifa | currency:'$':0"></small> <input type="text" ng-model="per.subtarifa" style="max-width:10ex;" v ng-init="per.subtarifa = per.subtarifa?per.subtarifa:per.tarifa"> </td>
					<td style="text-align: right">
				...
				<tr>
					<td colspan="12" class="right-align" > <b>Subtotal: </b> <span ng-bind="tr.persubtotal | currency"></span> </td>
				</tr>


				<tr>
					<th colspan="12" rowspan="" style="background:#ddedd0">EQUIPOS: <a ng-href="<?= site_url('export/formatoEquiposTareaOT') ?>/{{ tr.idtarea_ot }}" class="btn mini-btn2" data-icon="&#xe030;"></a></th>
				</tr>
				<tr ng-repeat="eq in tr.equipos | orderBy: 'codigo'">
					<td> <span data-icon="&#xe039;" style="color:#6ce25d" ng-click="dialog('Codigo interno: '+eq.codigo)"></span> <span ng-bind="eq.itemc_item"></span> </td>
					...
					<td style="text-align: right"> <small ng-bind="eq.subtarifa | currency:'$':0"></small> <input type="text" ng-model="eq.subtarifa" style="max-width:10ex;"  ng-init="eq.subtarifa = eq.subtarifa?eq.subtarifa:eq.tarifa"> </td>
					<td style="text-align: right">
				...
				<tr>
					<td colspan="12" class="right-align" > <b>Subtotal: </b> <span ng-bind="tr.eqsubtotal | currency"></span> </td>
				</tr>
				...
				<tr ng-repeat="m in tr.material | orderBy: 'codigo'">
					...
					<td style="text-align: right"> <small ng-bind="m.subtarifa | currency:'$':0"></small> <input type="text" ng-model="m.subtarifa" style="max-width:10ex;" ng-init="m.subtarifa = m.subtarifa?m.subtarifa:m.tarifa"> </td>
					<td style="text-align: right">
				...
				<tr>
					<td colspan="12" class="right-align" > <b>Subtotal: </b> <span ng-bind="tr.msubtotal | currency"></span> </td>
				</tr>
				...
				<tr ng-repeat="o in tr.otros | orderBy: 'codigo'">
					...
					<td style="text-align: right"> <small ng-bind="o.subtarifa | currency:'$':0"></small> <input type="text" ng-model="o.subtarifa" style="max-width:10ex;" ng-init="o.subtarifa = o.subtarifa?o.subtarifa:o.tarifa"> </td>
					<td style="text-align: right">
