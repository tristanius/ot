		...
		<table class="mytabla largWidth">
			...
			<tbody class="font11">
				...
				<tr ng-repeat="per in tr.personal | orderBy: 'codigo'">
					...
					<td style="text-align: right" >
						<small ng-bind="per.subtarifa | currency"></small>
				...
				<tr ng-repeat="eq in tr.equipos | orderBy: 'codigo'">
					...
					<td style="text-align: right"> <small ng-bind="eq.subtarifa | currency"></small> <input type="text" ng-model="eq.subtarifa" style="max-width:10ex;"  ng-init="eq.subtarifa = eq.subtarifa?eq.subtarifa:eq.tarifa"> </td>
					<td style="text-align: right">
				...
				<tr ng-repeat="m in tr.material | orderBy: 'codigo'">
					...
					<td style="text-align: right"> <small ng-bind="m.subtarifa"></small> <input type="text" ng-model="m.subtarifa" style="max-width:10ex;" ng-init="m.subtarifa = m.subtarifa?m.subtarifa:m.tarifa"> </td>
					<td style="text-align: right">
