		...
		<table class="mytabla largWidth">
			...
			<tbody class="font11">
				...
				<tr ng-repeat="act in tr.actividades | orderBy: 'codigo'">
					<td> <span data-icon="&#xe039;" ng-click="dialog('Codigo interno: '+act.codigo)"></span> {{ act.itemc_item }}</td>
				...
				<tr ng-repeat="per in tr.personal | orderBy: 'codigo'">
					<td> <span data-icon="&#xe039;" ng-click="dialog('Codigo interno: '+per.codigo)"></span> {{ per.itemc_item }}</td>
				...
				<tr ng-repeat="eq in tr.equipos | orderBy: 'codigo'">
					<td> <span data-icon="&#xe039;" ng-click="dialog('Codigo interno: '+eq.codigo)"></span> {{ eq.itemc_item }}</td>
