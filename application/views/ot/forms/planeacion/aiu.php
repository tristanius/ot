		...
		<table class="mytabla">
			...
			<tbody>
				<tr>
					...
					<td> <input type="text" ng-model="tr.a" ng-init="tr.a = (tr.a?tr.a:ot.a)" ng-change="calcularSubtotales()"> </td>
					<td> <span ng-bind="(tr.valor_recursos*tr.a) | currency"></span> </td>
				</tr>
				<tr>
					<td>Imprevistos</td>
					<td> <input type="text" ng-model="tr.i" ng-init="tr.i = (tr.i?tr.i:ot.i)" ng-change="calcularSubtotales()"> </td>
					<td> <span ng-bind="(tr.valor_recursos*tr.i) | currency"></span> </td>
				</tr>
				<tr>
					<td>Utilidad</td>
					<td> <input type="text" ng-model="tr.u" ng-init="tr.u = (tr.u?tr.u:ot.u)" ng-change="calcularSubtotales()"> </td>
