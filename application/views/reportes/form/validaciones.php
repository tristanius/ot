<div class="noMaterialStyles" ng-init='getEstadosDoc(<?= json_encode($estados) ?>)'>
  ...
  <section class="row">
    ...
    <fieldset class="col l3 m3 s12" ng-if="validPriv(50) && (rd.info.validado_pyco == 'VALIDO' || rd.info.validado_pyco == 'CORREGIDO')">
        ...
        <button type="button" class="btn mini-btn2 orange darken-2" ng-click="appyEstadoDoc('ABIERTO','CORREGIR')" ng-disabled="!validPriv(45)">Corregir</button>
        ...
        <button type="button" class="btn mini-btn2 orange darken-4" ng-click="appyEstadoDoc('CERRADO','CORREGIR GV')" ng-disabled="!validPriv(50)">Corregir GV</button>
    </fieldset>
