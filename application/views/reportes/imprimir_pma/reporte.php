...
<html>
	...
	<body>
		...
		<table border="1">
			...
			<tfoot>
			<tr>
				<td colspan="36" id="centrar">Con la firma del presente formato el trabajador reconoce haber sido notificado previamente  en los términos de ley de las horas ordinarias  y horas extras (cuando se aplique) reportadas.</td>
			</tr>
			<tr>
				<td colspan="36" id="centrar">
          ...
          Por lo tanto, queda estrictamente prohibido el uso, divulgación, distribución, reproducción, modificación y/o alteración de los mencionados derechos, con fines distintos a los previstos en este documento,
          sin la autorización previa y escrita del consorcio.
        </td>
			</tr>
			</tfoot>
		</table>
