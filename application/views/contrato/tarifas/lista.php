<div >
  <p>
    ...
    <button type="button" class="btn btn-small indigo darken-3">Agregar</button>
    <button type="button" class="btn btn-small" ng-click="">Importar</button>
    <button type="button" class="btn btn-small light-green accent-4">Exportar</button>
  </p>
